                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="name" id="name" class="form-control 
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="birth_place" id="birth_place" class="form-control 
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <textarea name="address" id="address" cols="20" rows="" class="form-control 
                            @error('address') is-invalid @enderror">{{ old('address') }}
                            </textarea>
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="religion" id="religion" class="form-control 
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control 
                                @error('marital_status') is-invalid @enderror">
                                @foreach ([
                                        (object) [
                                            'label' => 'Belum Menikah',
                                            'value' => 'single',
                        ...
                        <div class="form-grup mb-3">
                            ...
                            <input type="text" inputmode="numeric" name="occupation" id="occupation" class="form-control 
                        ...
                        <div class="form-grup mb-3">
                            ...
                            @error('phone') is-invalid @enderror" value="{{ old('nik') }}">
                            @error('phone')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
