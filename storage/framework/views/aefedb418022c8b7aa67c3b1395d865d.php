...
<head>
    ...
    <title>Desa Gita AN - Login</title>

    <!-- Custom fonts for this template-->
    <link href="<?php echo e(asset('temlate/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
    <link
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/register">Buat Akun Dulu!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Users\ACER\DesaGitaN\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>