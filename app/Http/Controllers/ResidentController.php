...
class ResidentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/resident')->with('success', 'Data Berhasil Ditambahkan Dong');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/resident')->with('success', 'Data Berhasil Diubah Dong');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/resident')->with('success', 'Berhasl Dihapus Dong');
    }
}
